#!/bin/bash
# FrameThinker Video-Holmes Training Script (Migrated to new verl)
# This script trains a video reasoning model using GRPO with ToolAgentLoop and VideoThinkTool
#
# Key changes from original:
# - Uses ToolAgentLoop instead of legacy agent.activate_agent
# - Tool configuration via tool_config_path
# - Multi-turn configuration via multi_turn.* parameters

set -x

# Data and model paths (same as original)
