...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.agent.custom_agent_router.path=verl/experimental/agent_loop/agent_loop_router/tool_agent.py \
    actor_rollout_ref.rollout.agent.custom_agent_router.name=always_tool_agent \
    ...
    trainer.default_local_dir=${SAVE_CHECKPOINT_DIR}/${PROJECT_NAME}/${EXP} \
